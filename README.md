...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/checks-519%20passing-8FBAFF?style=flat-square&labelColor=0B0C10" alt="519 automated checks passing">
...
**Verified, not asserted.** 519 automated checks run before every push — the parsers, the geometry, the privacy rules, and the arithmetic behind every readout. Every commit is signed.
